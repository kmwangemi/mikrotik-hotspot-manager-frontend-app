  ...
  useEffect(() => {
    const verifyToken = async () => {
      ...
      try {
        ...
        // In real app, call backend to verify token validity
                  ...
                  <FormItem>
                    ...
                    {field.value && (
                      <div className='mt-3 space-y-2 text-xs'>
                        <div
                          className={`flex items-center gap-2 ${field.value.length >= 8 ? 'text-green-500' : 'text-muted-foreground'}`}
                        >
                        ...
                        <div
                          className={`flex items-center gap-2 ${/[A-Z]/.test(field.value) ? 'text-green-500' : 'text-muted-foreground'}`}
                        >
                        ...
                        <div
                          className={`flex items-center gap-2 ${/[0-9]/.test(field.value) ? 'text-green-500' : 'text-muted-foreground'}`}
                        >
                        ...
                        <div
                          className={`flex items-center gap-2 ${/[^A-Za-z0-9]/.test(field.value) ? 'text-green-500' : 'text-muted-foreground'}`}
                        >
